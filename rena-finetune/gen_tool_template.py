...
def get_tool_list(category: str) -> list[str]:
    ...
    train_data_dir = current_path.parent.parent / "results" / "trajectories" / category / "train" / "tool_adaptors"
...
if __name__ == "__main__":
    ...
    with open("tool_template.jinja", "r") as f:
        template_str = f.read()
    tool_list = get_tool_list(args.category)

    output_dir = Path(__file__).parent.parent / "results" / "chat_templates" / args.category
